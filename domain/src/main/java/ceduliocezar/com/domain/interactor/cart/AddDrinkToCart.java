...
public class AddDrinkToCart extends UseCase<Void, Drink> {

    private CartRepository cartRepository;

    @Inject
    protected AddDrinkToCart(ThreadExecutor threadExecutor,
    ...
    @Override
    protected Observable<Void> buildUseCaseObservable(Drink drink) {
        return cartRepository.addDrinkToCart(drink).toObservable();
    }
}
